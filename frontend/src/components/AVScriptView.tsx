...
export const AVScriptView: React.FC<AVScriptViewProps> = ({ beats }) => {
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 pb-2 border-b border-slate-800">
        <div>
          <h3 className="text-base font-bold text-slate-100 flex items-center gap-2">
            <span>Two-Column AV Screenplay</span>
            ...
            <div
              ...
              className={`rounded-xl border transition-all duration-200 overflow-hidden cursor-pointer ${
                isSelected
                  ...
                  : 'bg-slate-950/60 border-slate-850 hover:border-slate-750 hover:bg-slate-900/40'
              }`}
            >
              {/* Beat Banner */}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 divide-y md:divide-y-0 md:divide-x divide-slate-800/80">
                    ...
                    <div className="pt-1 text-[10px] text-slate-500 flex flex-wrap items-center gap-1.5">
                      ...
                      {beat.source_citations.map((url, i) => (
                        <a
                          ...
                          target="_blank"
                          rel="noreferrer"
                          className="text-amber-400/80 hover:underline hover:text-amber-300 truncate max-w-[200px]"
                        >
                ...
                <div className="p-4 space-y-3 bg-slate-900/30">
                  ...
                  <p className="text-sm text-slate-200 leading-relaxed font-sans selection:bg-amber-500/30">
                    {beat.visual_description}
                  </p>
